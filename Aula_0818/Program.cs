...
class Program {
    ...
    do {
      try {
        ...
        switch (op) {
          ...
          case 02 : ProdutoListarOrdemPreco(); break;
          case 03 : ClienteInserirProduto(); break;
          case 04 : ClienteVerCarrinho(); break;
          case 05 : ClienteConfirmarCarrinho(); break;
          case 06 : ClienteListarVendas(); break;
        }
      }
      catch (Exception erro) {
        Console.WriteLine(erro.GetType() + "\n" + erro.Message);      
  ...
  public static int MenuCliente() {
    ...
    Console.WriteLine("  02 - Listar Produtos Ordem de Preço");
    Console.WriteLine("  03 - Inserir Produto no Carrinho");
    Console.WriteLine("  04 - Ver o Carrinho");
    Console.WriteLine("  05 - Confirmar o Carrinho");
    Console.WriteLine("  06 - Ver as Compras Anteriores");
    Console.WriteLine("----------------------");
    Console.WriteLine("  99 - Logout");
    Console.WriteLine("----------------------");
    Console.Write("Opção: ");
  ...
  public static void ClienteConfirmarCarrinho() {
    ...
    Console.WriteLine("Confirmar a compra (s/n)?");
    ...
    if (s == "s") {
      ...
      carrinho = NVenda.ListarCarrinho(clienteLogado);      
      // carrinho = new Venda();
  ...
  public static void ProdutoListarOrdemPreco() {
    Console.WriteLine("----- Lista de Produtos -----");
    foreach(Produto obj in NProduto.ListarOrdemPreco())
      Console.WriteLine(obj + " - Categoria: " +
        NCategoria.Listar(obj.IdCategoria).Descricao);
  }
